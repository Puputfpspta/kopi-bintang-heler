...
if (isset($_POST['login'])) {
    ...
    if ($stmt->num_rows > 0) {
        ...
        // Debugging: tampilkan password yang di-hash dan password yang dimasukkan
        echo "Password from DB: " . $hashed_password . "<br>";
            ...
            <div class="login-form">
                ...
                <form action="login.php" method="POST">
                    ...
                    <div id="admin-fields" class="form-group" style="display: none;">
                        ...
                        <input type="text" id="admin-username" name="admin-username" maxlength="50">
                    </div>
                    <div class="form-group">
